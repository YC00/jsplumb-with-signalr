<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkManagement.aspx.cs" Inherits="Microsoft.AspNet.SignalR.Samples.Hubs.ShapeShare.admin.LinkManagement" %>
...
<body>
    ...
    <div style="width: 70%; float:right">
        <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Link Management</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
<!-- Nav tabs -->
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="#home" data-toggle="tab">連接線段Template</a></li>
      <li style="display:none;"><a href="#group" data-toggle="tab">Template Group</a></li>
  <li><a href="#profile" data-toggle="tab" id="profilebutton">新增連接線段Template</a></li>
</ul>
    <!-- Tab panes -->
<div class="tab-content" style="overflow:hidden;">
     <div class="tab-pane" id="group">
            <div class="theme-showcase" style="display:none;margin-top:20px;">
               
            </div>
     </div>
  <div class="tab-pane active" id="home">
      <div class="theme-showcase" style="margin-top:20px;">
          ...
          <div style="float:right;">
              ...
              <asp:Button ID="Button3" CssClass="btn btn-success" runat="server" Text="儲存" OnClick="ButtonSelectNodeTemplate_Click" />
          </div>
  ...
  <div class="tab-pane" id="profile">
      <div class="theme-showcase" style="margin-top:10px;">
  ...
  <div class="panel-body">
            ...
            <br />
          <asp:Label ID="Label2" runat="server" Text="Link Template : "></asp:Label>
...
<div class="panel-group" id="Div1">
 ...
 <div id="collapseTwo" class="panel-collapse collapse in">
      ...
      <div style="float:right;">
        <asp:Button ID="Button1" runat="server"  onclick="ButtonSave_Click"  Text="儲存" CssClass="btn btn-success" />&nbsp;
        <asp:Button ID="Button2" runat="server" Text="取消" CssClass="btn btn-warning" />
      </div>
</div>
</div>
             </div>  
