...
{
    public partial class DragFlow : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static void MyMethod(string id1, string id2, string id3, string keyword1, string keyword2, string keyword3, string groupid)
        {
            // Singleton instance
            int i = 1;
            IHubContext _context = GlobalHost.ConnectionManager.GetHubContext<ShapeShare>();
            if (keyword1!="")
                _context.Clients.Group(groupid).keywordShapeCreated(id1, i++.ToString() + ". " + keyword1, "0", "130");
            if (keyword2 != "")
                _context.Clients.Group(groupid).keywordShapeCreated(id2, i++.ToString() + ". " + keyword2, "10", "140");
            if (keyword3 != "")
                _context.Clients.Group(groupid).keywordShapeCreated(id3, i.ToString() + ". " + keyword3, "20", "150");
