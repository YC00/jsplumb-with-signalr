<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditorTool.aspx.cs" Inherits="Microsoft.AspNet.SignalR.Samples.Hubs.ShapeShare.EditorTool" %>
                        ...
                        'OK': {
                            ...
                            click: function () {
                                ...
                                $.ajax({
                                    ...
                                    url: "EditorTool.aspx/CreateConceptMap",
                                    ...
                                    success: function (data) {
                                        ...
                                        if (parseInt(data.d) > 0) {
                                            ...
                                            $.each(jsPlumb.getConnections(), function (idx, connection) {
                                                ...
                                                if (templateData != 'undefined') {
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        contentType: "application/json; charset=utf-8",
                                                        url: "EditorTool.aspx/InsertLinkFieldsData",
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                contentType: "application/json; charset=utf-8",
                                                url: "EditorTool.aspx/NewInsertConnectionData",
                                            ...
                                            $("#designpannel .component").each(function (idx, elem) {
                                                ...
                                                blocks.push({
                                                    ...
                                                    createdDateTime:  String($elem.attr('ctime'))
                                                });
                                                ...
                                                if (templateData != 'undefined') {
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        contentType: "application/json; charset=utf-8",
                                                        url: "EditorTool.aspx/InsertNodeFieldsData",
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                contentType: "application/json; charset=utf-8",
                                                url: "EditorTool.aspx/NewInsertNodeData",
...
user-select: none;">
    ...
    <textarea class="form-control" id="chatwindow" style="height:400px;width:100%;overflow: auto;cursor:text;"></textarea>
    <input type="text" id="chatinput"  style="width:100%;" autofocus />
</div>
